...
const props = {
  ...
  preview: [
    ...
    { name: "Obi", _id: 2, phone: "+23480846474" }
  ],
...
storiesOf("FileUpload", module)
  .add("single file upload with xlsx preview", () => (
    <FileUpload {...props} valueChanged={valueChanged} />
  ))
  .add("single file upload with image preview", () => (
    <FileUpload {...imageProps} valueChanged={valueChanged} />
  ));
